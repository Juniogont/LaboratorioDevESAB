        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    UsuarioId = table.Column<string>(maxLength: 36, nullable: true),
                    EmpresaId = table.Column<int>(nullable: false),
                    UsuarioId1 = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmpresaUsuarios", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmpresaUsuarios_Empresa_EmpresaId",
                        column: x => x.EmpresaId,
                        principalTable: "Empresa",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmpresaUsuarios_Usuario_UsuarioId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmpresaUsuarios_EmpresaId",
                table: "EmpresaUsuarios",
                column: "EmpresaId");

            migrationBuilder.CreateIndex(
                name: "IX_EmpresaUsuarios_UsuarioId1",
                table: "EmpresaUsuarios",
                column: "UsuarioId1");
        }
